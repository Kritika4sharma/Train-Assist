...
var client = {
    ...
    predict: function (data) {
        var uuid = this.uuid();
        this.socket.send(JSON.stringify({method: "predict_delay", id: uuid, params: {number: data}}));
        this.queue[uuid] = "predict_delay";
    }
};
