...
svm_model_linear = SVC(kernel = 'linear', probability = True).fit(X_train, y_train)
...
eclf1 = VotingClassifier(estimators=[('lsvm', svm_model_linear), ('rf', clf), ('gbc', clf2)], voting = 'soft')
